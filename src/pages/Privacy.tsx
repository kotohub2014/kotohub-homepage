      ...
      <section className="section" style={{ paddingTop: 56 }}>
        <div className="container" style={{ maxWidth: 860 }}>
          <Reveal className="prose">
            ...
            <h2>8. 広告について</h2>
            <p>
              当事業が運営するサービス（ai-mate）では、Google
              をはじめとする第三者配信事業者の広告を掲載しています。これらの事業者は、Cookie
              や広告識別子を使用して、利用者の過去のアクセス情報に基づく広告を表示することがあります。
            </p>
            <ul>
              <li>氏名・メールアドレス・会話の内容が広告事業者へ渡ることはありません。</li>
              <li>
                パーソナライズ広告は{' '}
                <a
